...
def NOTIFIED_ACCEPT_GROUP_INVITATION(op):
    #print op
    try:
        sendMessage(op.param1, client.getContact(op.param2).displayName + "WELCOME to\n " + group.name)
    except Exception as e:
        print e
            ...
            if msg.contentType == 0:
                ...
                if "nk:" in msg.text:
                    ...
                    if key in Names:
                        ...
                        sendMessage(msg.to, "apa dosanya?")
                if msg.text == "cancel":
                    group = client.getGroup(msg.to)
                ...
                if msg.text == "gift":
                    sendMessage(msg.to, text="gift sent", contentMetadata=None, contentType=9)
                if msg.text == "set":
                    sendMessage(msg.to, "silahkan ketik tes untuk melihat sider ♪")
                    try:
